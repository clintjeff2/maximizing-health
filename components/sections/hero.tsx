...
export default function Hero({ language, onWhatsAppClick }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-background via-secondary/40 to-background pt-24 sm:pt-28 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute -top-32 right-0 h-64 w-64 sm:h-96 sm:w-96 rounded-full bg-accent/10 blur-[120px]" />
        <div className="absolute bottom-0 left-1/4 h-64 w-64 sm:h-[34rem] sm:w-[34rem] rounded-full bg-red-600/10 blur-[140px]" />
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 sm:gap-12 items-center">
          <div className="space-y-6 sm:space-y-10">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] text-accent font-semibold">
                Miira-Cell+ • Revoobit International
              </p>
              <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold text-foreground text-balance leading-tight">
                {t.headline}
              </h1>
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground text-balance leading-relaxed max-w-2xl">
                {t.subheadline}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
              <Button
                ...
                className="px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base text-white font-semibold rounded-full transition transform hover:scale-[1.02] shadow-lg hover:shadow-xl w-full sm:w-auto"
              ...
              <Button
                asChild
                variant="outline"
                className="px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-semibold rounded-full border-2 border-accent text-foreground hover:bg-accent/10 bg-transparent w-full sm:w-auto"
              >
                <a
                  href="#ingredients"
              ...
              <Button
                ...
                className="px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-semibold rounded-full border border-accent text-accent hover:bg-accent hover:text-white transition w-full sm:w-auto"
                variant="ghost"
              >
                {t.tertiaryCta}
              </Button>
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="relative rounded-2xl sm:rounded-[2.5rem] border border-border bg-gradient-to-br from-foreground/95 via-foreground to-foreground/90 p-6 sm:p-10 shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 space-y-4 sm:space-y-6 text-center">
                <p className="text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.25em] text-white/60">
